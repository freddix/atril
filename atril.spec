...
BuildRequires:	mate-icon-theme-devel >= 1.8.0
...
%package -n caja-extension-document-viewer
Summary:	Atril extension for Nautilus
Group:		X11/Applications
Requires:	%{name} = %{version}-%{release}
Requires:	caja >= 1.8.0
Provides:	mate-file-manager-extension-document-viewer = %{version}-%{release}
Obsoletes:	mate-file-manager-extension-document-viewer <= %{version}-%{release}

%description -n caja-extension-document-viewer
...
%files -n caja-extension-document-viewer
%defattr(644,root,root,755)
